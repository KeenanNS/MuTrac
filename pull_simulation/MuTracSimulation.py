...
MAX_DISPLACEMENT = 0.009 # flow rate of oil in m^3 you need to find this constant
...
class Tractor:
	...
	def get_distance_from_displacement(self):
...
class Sled:
	def __init__(self, rate_of_increase, starting_weight, max_weight):
...
MH2 = Tractor(1,1,1)
sled = Sled(100, 10000, 100000000)

current_position = 0

while(1):
	sled_load = sled.get_current_load(current_position)
	print(MH2.get_requested_power(1, sled_load),MH2.max_available_power(1))
